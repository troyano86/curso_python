#Calculadora con interfas grafica utilizando libreria tkinter tk
#from tkinter import * ----de estamanera importamos todas las utilidades de la libreria tkinter
